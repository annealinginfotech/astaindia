        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <button class="btn btn-success d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#createPermission">
                        ...
                        <tbody>
                            @foreach ($permissions as $item)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-primary btn-sm btn-pill editPermission" data-bs-toggle="modal" data-bs-target="#createPermission" value="{{$item->id}}">
                ...
                <form name="permission-create-form" method="POST" action="{{route('permissions.store')}}">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="permission_group_name" id="permission_group_name" placeholder="e.g. User">
                        </div>
                        <div class="mb-3">
...
@section('footerFiles')
    ...
    <script>
        ...
        $('#example').on('click', '.editPermission', function () {
            var permission_id   =   $(this).val();
            var permissionURL   =   "{{ route('permissions.edit', ":id") }}";
            permissionURL       =   permissionURL.replace(":id", permission_id);
            $.ajax({
                type: 'GET',
                url:  permissionURL,

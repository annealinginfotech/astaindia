        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('roles.create') }}" class="btn btn-success d-none d-sm-inline-block">
                        ...
                        <a href="{{ route('roles.create') }}" class="btn btn-success d-sm-none btn-icon" aria-label="Create new report">
                            ...
                            @foreach ($roles as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger btn-sm btn-pill delete-confirm" value="{{$item->id}}">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                                stroke-linecap="round" stroke-linejoin="round"

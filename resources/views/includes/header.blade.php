        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown {{(request()->is('roles*') || request()->is('permissions*') || request()->is('users*')) ? 'active' : ''}}">
                    ...
                    <li class="nav-item dropdown {{(request()->is('base-course*') || request()->is('main-course')) ? 'active' : ''}}">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item {{(request()->is('base-course') || request()->is('base-course/create')) ? 'active' : ''}}" href="{{route('base-course.index')}}">
                                    ...
                                    <a class="dropdown-item {{(request()->is('main-course') || request()->is('main-course/create')) ? 'active' : ''}}" href="{{route('main-course.index')}}">
                    ...
                    <li class="nav-item dropdown {{(request()->is('fees-structure') || request()->is('fees-structure*')) ? 'active' : ''}}">
                        <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown"
                            data-bs-auto-close="outside" role="button" aria-expanded="false">
                            <span
                                class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item {{(request()->is('fees-structure') || request()->is('fees-structure*')) ? 'active' : ''}}" href="{{route('fees-structure.index')}}">
                                        <span style="margin-right: 10px;"><svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-adjustments-alt"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M4 8h4v4h-4z" /><path d="M6 4l0 4" /><path d="M6 12l0 8" /><path d="M10 14h4v4h-4z" /><path d="M12 4l0 10" /><path d="M12 18l0 2" /><path d="M16 5h4v4h-4z" /><path d="M18 4l0 1" /><path d="M18 9l0 11" /></svg></span>

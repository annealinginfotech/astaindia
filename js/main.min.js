!(function () {
    ...
    var e = {
        ...
        t = function () {
            jQuery(".js-backtotop").on("click", function (e) {
                e.preventDefault(), jQuery("html, body").animate({ scrollTop: jQuery("body").offset().top }, 700, "easeInOutExpo");
            });
        },
        o = function () {
        ...
        i = function () {
            ...
            e.owlCarousel({
                ...
                responsive: { 0: { items: 1 }, 400: { items: 1 }, 600: { items: 2 }, 1e3: { items: 3 } },
            }),
                ...
                (e = jQuery(".owl-work")).owlCarousel({
                    ...
                    responsive: { 0: { items: 1, stagePadding: 10 }, 500: { items: 2, stagePadding: 20 }, 600: { items: 2, stagePadding: 40 }, 800: { items: 2, stagePadding: 100 }, 1100: { items: 3 }, 1400: { items: 4 } },
                });
        },
        r = function () {
            function e(e) {
        ...
        s = function () {
            jQuery(".flexslider").flexslider({ animation: "fade", prevText: "", nextText: "", slideshow: !0 });
        },
        u = function () {
            jQuery(".probootstrap-showcase-nav ul li a").on("click", function (e) {
                var t = jQuery(this),
                    o = t.closest("li").index();
                t.closest(".probootstrap-feature-showcase").find(".probootstrap-showcase-nav ul li").removeClass("active"),
                    t.closest("li").addClass("active"),
                    t.closest(".probootstrap-feature-showcase").find(".probootstrap-images-list li").removeClass("active"),
                    t.closest(".probootstrap-feature-showcase").find(".probootstrap-images-list li").eq(o).addClass("active"),
                    e.preventDefault();
            });
        },
        l = function () {
        ...
        c = function (e) {
            for (
                var t = function (e) {
                        for (var t, o, n, a, i = e.childNodes, r = i.length, s = [], u = 0; u < r; u++)
                            1 === (t = i[u]).nodeType &&
                                ((n = (o = t.children[0]).getAttribute("data-size").split("x")),
                                (a = { src: o.getAttribute("href"), w: parseInt(n[0], 10), h: parseInt(n[1], 10) }),
                                t.children.length > 1 && (a.title = t.children[1].innerHTML),
                                o.children.length > 0 && (a.msrc = o.children[0].getAttribute("src")),
                                (a.el = t),
                                s.push(a));
                        return s;
                    },
                    ...
                    n = function (e, o, n, a) {
                        ...
                        isNaN(i.index) || (n && (i.showAnimationDuration = 0), new PhotoSwipe(s, PhotoSwipeUI_Default, r, i).init());
                    },
        ...
        d = function () {
            if (jQuery(".portfolio-feed").length > 0) {
                ...
                e.imagesLoaded(function () {
                    e.isotope({ itemSelector: ".grid-item", percentPosition: !0, masonry: { columnWidth: ".grid-sizer", gutter: ".gutter-sizer" } });
                });
            }
        },
        p = function () {
        ...
        f = function () {
            jQuery("#probootstrap-counter").length > 0 &&
                jQuery("#probootstrap-counter").waypoint(
                    function (e) {
                        "down" !== e || jQuery(this.element).hasClass("probootstrap-animated") || (setTimeout(p, 400), jQuery(this.element).addClass("probootstrap-animated"));
                    },
                    { offset: "90%" }
                );
        },
    ...
    jQuery(document).ready(function () {
        a(), u(), l(), jQuery(".probootstrap-gallery").length > 0 && c(".probootstrap-gallery"), d(), f(), r(), t(), n(), o(), m();
    }),
